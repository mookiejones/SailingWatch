package com.solutions.nerd.sailing.sailingwatchface.apis;
 ...
 */
        ...
        import com.solutions.nerd.sailing.sailingwatchface.ui.camera.GraphicOverlay;
...
class FaceTrackerFactory implements MultiProcessor.Factory<Face> {
    ...
    public Tracker<Face> create(Face face) {
        MultiFaceGraphic graphic = new MultiFaceGraphic(mGraphicOverlay);
 ...
 * view.
 */
class MultiFaceGraphic extends TrackedGraphic<Face> {
    ...
    MultiFaceGraphic(GraphicOverlay overlay) {
        super(overlay);
