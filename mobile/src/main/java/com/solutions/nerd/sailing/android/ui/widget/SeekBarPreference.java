package com.firstmate.android.ui.widget;
...
//TODO Need to create this so that it can auto convert the display

    private final String TAG = getClass().getName();

    private static final String ANDROIDNS="http://schemas.android.com/apk/res/android";
    private static final String APPLICATIONNS="http://first-mate.appspot.com";
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs,R.styleable.SliderPreference);
        mMaxValue = a.getInt(R.styleable.SliderPreference_max,100);
        mMinValue = a.getInt(R.styleable.SliderPreference_min,0);
        ...
        mUnitsRight = a.getString(R.styleable.SliderPreference_unitsRight);
        mUnitType = attrs.getAttributeIntValue(APPLICATIONNS,"unitsType",1);
