...
public class SailingConfigurationActivity extends Activity implements
    ...
    private static class ColorItem extends LinearLayout implements
        ...
        public ColorItem(Context context) {
            ...
            mShrinkCircleAnimator = ObjectAnimator.ofFloat(mColor,Consts.CIRCLE_NAME, mExpandCircleRadius, mShrinkCircleRadius);
            mShrinkLabelAnimator = ObjectAnimator.ofFloat(mLabel, Consts.ALPHA, EXPAND_LABEL_ALPHA, SHRINK_LABEL_ALPHA);
            ...
            mExpandCircleAnimator = ObjectAnimator.ofFloat(mColor, Consts.CIRCLE_NAME, mShrinkCircleRadius, mExpandCircleRadius);
            mExpandLabelAnimator = ObjectAnimator.ofFloat(mLabel, Consts.ALPHA, SHRINK_LABEL_ALPHA, EXPAND_LABEL_ALPHA);
